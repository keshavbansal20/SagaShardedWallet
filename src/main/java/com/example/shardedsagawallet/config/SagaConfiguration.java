...
import com.example.shardedsagawallet.steps.CreditDestinationWalletStep;
import com.example.shardedsagawallet.steps.DebitSourceWalletStep;
import com.example.shardedsagawallet.steps.UpdateTransactionStatus;
...
public class SagaConfiguration {
    ...
    public Map<String , SagaStepInterface> sagaStepMap(
        ...
        map.put(SagaStepType.UDPATE_TRANSACTION_STATUS_STEP.toString(),updateTransactionStatus);
